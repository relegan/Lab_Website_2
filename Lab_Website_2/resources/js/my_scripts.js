...
function loadStatsPage()
{
	...
	var tableLosses = document.getElementById("losses");
	var row_cnt, cell_val1, cell_val2, winner, winners_name;
	var wins = 0;
	var losses = 0;

	for(row_cnt = 2; row_cnt < table1.rows.length; row_cnt++)
	{
			cell_val1 = table1.rows[row_cnt].cells[2].innerHTML;
			cell_val2 = table1.rows[row_cnt].cells[3].innerHTML;
			winner = cell_val1 - cell_val2;

			if(winner < 0)
			{
				winners_name = table1.rows[row_cnt].cells[1].innerHTML;
				losses++;
			}
			else
			{
				winners_name = "CU Boulder";
				wins++;
			}
			table1.rows[row_cnt].cells[4].innerHTML = winners_name;
	}
	tableWins.innerHTML = wins;
	tableLosses.innerHTML = losses;
}
...
{
	var select_player = document.getElementById('player_selector');
	...
	for(var i = 0; i < players.length; i++)
	{
		...
		select_player.appendChild(x);
		var br = document.createElement('br');
		select_player.appendChild(br);
	}
}
